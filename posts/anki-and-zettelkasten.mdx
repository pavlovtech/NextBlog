...
![Logo](/assets/anki-zettelkasten.jpg)
...
Permanent notes require additional processing before going to Anki. You should create Anki cards in form of questions or with [Cloze Deletions](https://docs.ankiweb.net/editing.html#cloze-deletion).

I recommend to adhere to the following principles when creating Anki cards:
