...
This article will describe a roadmap to becoming a badass .NET developer. I will start with the C# language itself and walk you through the popular frameworks and technologies that are used in production.
...
## Step 11. 3rd party .NET libraries that are de facto standard in the indastry
...
2. [Serilog](https://serilog.net/) — best library for logging. It enables logging to a file, database, or console with just a few configuration lines.
...
5. [Polly](https://github.com/App-vNext/Polly) — .NET resilience library mostly used to retry and rate limit some operations. Especially useful for high-load microservice architecture.
...
One of the best book on interview preparation is [Cracking the Coding Interview by Gayle Laakmann McDowell.](https://www.amazon.com/Cracking-Coding-Interview-Programming-Questions/dp/0984782850)
